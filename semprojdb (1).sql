...
(2, 'Cortino', 'Angel Mae', 25, NULL, 14000, 15321, NULL),
(3, 'Cortino', 'Angel Mae', 25, NULL, 14000, 15321, NULL),
(4, 'Cortino', 'Angel Mae', 25, '2024-11-21', 14000, 15384, NULL),
(5, 'Cortino', 'Angel Mae', 25, '2024-11-21', 14000, 15466, NULL),
(6, 'Consigo', 'Rica', 24, '2024-11-13', 14000, 14828, 32);
...
INSERT INTO `payment` (`PaymentID`, `billingID`, `TenantID`, `LastName`, `FirstName`, `DateRegistered`, `TotalRentBill`, `AmountPaid`, `PaymentDate`, `ReceiptNo`) VALUES
(1, 4, 0, '', '', '2024-11-21', 15384, 15384, '2024-11-12', 111),
(2, 4, 0, '', '', '2024-11-21', 15384, 15384, '2024-11-22', 112),
(3, 5, 0, '', '', '2024-11-21', 15466, 15466, '2024-11-22', 1234),
(4, 6, 0, 'Rica', 'Consigo', '2024-11-13', 14828, 14828, '2024-11-21', 12345);
...
ALTER TABLE `payment`
  ...
  ADD KEY `idx_payment_tenant_id` (`TenantID`),
  ADD KEY `idx_payment_billing_id` (`billingID`);
...
--
ALTER TABLE `payment`
  ADD CONSTRAINT `fk_billing` FOREIGN KEY (`billingID`) REFERENCES `billing` (`BillingID`) ON DELETE CASCADE ON UPDATE CASCADE;
