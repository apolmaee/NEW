...
public class Billing extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Payment ID", "First Name", "Last Name", "Unit ID", "Date Registered", "Monthly Rat", "Total Bill"
            }
        ));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(jtxtMrate, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 364, Short.MAX_VALUE)
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    .addComponent(jLabel9)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jLabel4))
                                .addComponent(jtxtWtrUsage, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 364, Short.MAX_VALUE)
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    .addComponent(jLabel10)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jLabel6))
                                .addComponent(jtxtElecUsage, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 364, Short.MAX_VALUE)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        try {
            ...
            PreparedStatement pst = connect.prepareStatement(
                "INSERT INTO billing (LastName, FirstName, UnitID, DateRegistered, MRate, TotalBill) VALUES (?, ?, ?, ?, ?, ?)"
            );
            pst.setString(1, lastname);
            pst.setString(2, firstname);
            pst.setString(3, unit);
            pst.setString(4, date);
            pst.setString(5, mrate);
